...
## Step 4 — Finalize and keep it somewhere you'll see it again

Write the final 1-2 page version in a document you'll actually keep —
not just this exercise's scratch notes. You'll revisit and expand this
statement at the end of Level 2 (the coaching plan), Level 3 (the team
development plan), and Level 4 (the capstone leadership development
program), so treat this as a living document, not a one-time writing
exercise.

## Cheat sheet — what each section draws on

| Section | Level 1 module it draws on |
|---|---|
| What leadership is for | Module 1 — Greenleaf's test |
| What I know about my own patterns | Module 2 — self-awareness, reaction log |
...
following the four-section structure above, using your actual Level 1
exercise answers as raw material rather than generic language. Save it in
a document you'll return to. Completing this project means you're ready
